...
def ode_gen_quorum(y: list, t: list,  alpha: list, n: list, kd:list, deg:list, misc:list) -> list:
    ...
    values = [
              ...
              alphaR*pT - (k1R/kd1)*(LuxR**2)*(A**2) + k1R*LuxR_A - (mu+ dR)*LuxR,
              ...
              (alphaI*AcP + alpha0*inAcP)*nA*Vc*N + k1R*LuxR_A - (k1R/kd1)*(LuxR**2)*(A**2)  - (mu + dA)*A,
...
def ode_gen_qcrispri(y: list, t: list,  alpha: list, n: list, kd: list, deg: list, misc: list, t_start_decay) -> list:
    ...
    nA = n
    k1R, k2R, kcasR, kd1, kd2, kdCas, k_d = kd  #Dissociation constants and reverse rates
    ...
    if (t > t_start_decay):
        values = [
              ...
              alphaR*pT - (k1R/kd1)*(LuxR**2)*(A**2) + k1R*LuxR_A - (mu + dR)*LuxR,   
              #5. AHL
              (alphaI*AcP + alpha0*inAcP)*nA*Vc*N - (mu + dA)*A,  
              #6. LuxR_A   
              (k1R/kd1)*(LuxR**2)*(A**2) - k1R*LuxR_A - (k2R/kd2)*LuxR_A*inAcP + k2R*AcP - (dc+mu)*LuxR_A ,      
...
def ode_gen_qcrispri_simple(y: list, t: list, alpha: list, n: list, kd: list, deg: list, misc: list, t_start_decay) -> list:
    ...
    Kdeg_A, Kdeg_Cas, Kdeg_G, k_d1 = deg  #Degradation rates
